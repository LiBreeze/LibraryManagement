        ...
        selectFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED)
                {
                    ...
                    ActivityCompat.requestPermissions(Projects.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
            }
        });
                                    ...
                                    reference.child(fileName).setValue(url1).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if (task.isSuccessful())
                                                ...
                                                Toast.makeText(getApplicationContext(), "File Not Successfully Uploaded", Toast.LENGTH_LONG).show();
