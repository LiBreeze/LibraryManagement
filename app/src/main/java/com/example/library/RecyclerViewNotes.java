...
public class RecyclerViewNotes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Notes").child(getIntent().getStringExtra("subject"));
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RecyclerViewNotes.this));
        AdapterFiles adapterFiles = new AdapterFiles(recyclerView, RecyclerViewNotes.this, new ArrayList<String>(), new ArrayList<String>());
